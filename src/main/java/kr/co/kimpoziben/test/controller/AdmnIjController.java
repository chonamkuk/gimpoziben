...
@Controller
@AllArgsConstructor
@RequestMapping("/test/admin/ij")
public class AdmnIjController {
    @Autowired
...
//        pageable.setDirection(Sort.Direction.DESC);
    ...
    public String detail(Model model, IjDto ijDto, SearchDto searchDto, final PageRequest pageable
        ...
        IjDto resultDto = null;


        resultDto = ijService.getAsDetail(ijDto.getSeqAs());
    ...
    @ResponseBody
    public Object asImgDelete(@RequestBody IjDto ijDto) throws Exception {
        HashMap<String,Object> resultMap = new HashMap<>();
        attachService.updateDelYn(ijDto);
    ...
    public String delete(IjDto ijDto, HttpServletResponse response) throws Exception {
        ...
        return "redirect:/test/admin/ij/list.do";
    }
}
