...
public class IjDto {
    ...
    public IjEntity toEntity() {
        IjEntity ijEntity = IjEntity.builder()
                .seqAs(seqAs)
                .titleAs(titleAs)
                .resStartDtAs(resStartDtAs)
                .resEndDtAs(resEndDtAs)
    ...
    @Builder
    public IjDto(Long seqAs, String titleAs, LocalDateTime resStartDtAs, LocalDateTime resEndDtAs, String contentsAs, String noTelAs, BigDecimal latitudeAs, BigDecimal longitudeAs,
