 ...
 * app-assets/vendors/dropify/js/dropify.min.js
 * =============================================================
 */
    ...
    return (
        (i.prototype.onChange = function () {
            ...
            (i.prototype.setPreview = function (i, t) {
                this.wrapper.removeClass("has-error").addClass("has-preview"),
                    this.filenameWrapper
                        ...
                        .html(this.settings.defaultFileName ? this.settings.defaultFileName : this.file.name);
            ...
            (i.prototype.isImage = function () {
                return "-1" != this.settings.imgFileExtensions.indexOf(this.getFileType()) || "-1" != this.file.name.indexOf("ImgView.do") ? !0 : !1;
            }),
